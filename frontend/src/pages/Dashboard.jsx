...
import { Fan, LucideFilePlus, LucideTrash2 } from 'lucide-react'
...
//it will show if completed it will ++
const fetchAllResumes = async () => {
  ...
  interests: resume.interests || [],
    ...
    console.log("✅ resumes to render:", resumesWithCompletion)
    ...
    <div className={styles.headerWrapper}>
      <div>
        ...
        <p className={styles.headerSubtitle}>
          ...
          : 'Start building you professional resumes'}
        </p>
      </div>
          ...
          {/* empty state */}
            {!loading && allResumes.length === 0 && (
              <div className={styles.emptyStateWrapper}>
                ...
                <p className={styles.emptyText}>You haven't created any resumes yet. Start building your professional resume to land you dream job</p>
