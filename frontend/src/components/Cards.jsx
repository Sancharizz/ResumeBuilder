      ...
      ${isSelected ? 'border-violet-500 shadow-lg shadow-violet-500/20 bg-violet-50' 
        ...
        {thumbnailImg ? (
          <div className=" relative w-full h-full overflow-hidden">
            ...
            <div className=" absolute inset-0 bg-linear-to-t from-white/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            {isSelected && (
            ...
            {/* hover effect */}
            <div className=" absolute inset-0 bg-linear-to-t from-violet-100/30 to-transparent opacity-0 grop-hover:opacity-100 transition-opacity duration-300">
            </div>
          </div>
        ) : (
          <div className=" w-full h-[200px] flex items-center flex-col justify-center bg-linear-to-br from-violet-50 via-violet-600 to-fuchsia-50">
